 ...
 */
#define MODE_WPARAS     (MODE_CHANOP|MODE_VOICE|MODE_BAN|MODE_KEY|MODE_LIMIT|MODE_APASS|MODE_UPASS|MODE_EXCEPTION)

/** Available Channel modes */
#define infochanmodes feature_bool(FEAT_OPLEVELS) ? "AcCbiklmMnopstUvrDRz" : "cCbiklmMnopstvrDRz"
